...
app.UseCors(opt =>
{
    opt.AllowAnyHeader().AllowAnyMethod().AllowCredentials().WithOrigins("http://localhost:3000", "https://ftadashboard.netlify.app/"); // ("https://example.com", "https://another-allowed-origin.com")
});
