    ...
    public partial class NewEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", maxLength: -1, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FacilitatingInstitution = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Location = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateCandidatesGroup", x => new { x.CandidatesId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_CandidateCandidatesGroup_Candidates_CandidatesId",
                        column: x => x.CandidatesId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateCandidatesGroup_Groups_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_CandidateId",
                table: "AttendanceRecords",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateCandidatesGroup_GroupsId",
                table: "CandidateCandidatesGroup",
                column: "GroupsId");
